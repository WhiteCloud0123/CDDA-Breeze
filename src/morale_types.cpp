...
const morale_type MORALE_LOVE( "morale_love" );    // 标记 在此处添加 morale_type MORALE_LOVE
...
static const morale_type morale_love( "morale_love" );  // 标记 添加 static const morale_type morale_love( "morale_love" ); 
...
const morale_type &morale_type_data::convert_legacy( int lmt )
{
    static const std::vector<morale_type> legacy_morale_types = {{
            ...
            morale_love,           // 标记 在此处添加 morale_love,
