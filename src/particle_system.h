...
public:
     ...
     */
     float getTangentialAccel() const;
     ...
     */
     float getTangentialAccelVar() const;
     ...
     */
     float getRotatePerSecondVar() const;
    ...
    /** initializes a ParticleSystem*/
     ...
     void resetTotalParticles(int numberOfParticles);
     bool isPaused() const;
     void pauseEmissions();
